...
this repo's own docs, opens it in a new tab, and exercises both ways of
closing the drawer (the Close button and clicking the backdrop outside
it, #138 review answer 4)."
  (%e2e-object
   ...
   (list
    ...
    ;; The root listing (/app) is lazy -- built the first time the panel
    ...
    ;; APPLICATION.LISP's (CLOG-CONNECTION:ADD-PLUGIN-PATH "^/app/" "/").
    (%e2e-step "click_new_tab"
               "selector" ".file-tree-file:has-text(\"sm-harness-web-ui.md\")"
               "url_pattern" "/app/harness/docs/sm-harness-web-ui\\.md$"
