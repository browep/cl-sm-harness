...
| MCP, callbacks, hooks, sessions, stores, mirroring | deferred (partial capability) | Phase 7 — control plane, session-start SDK MCP tools (#20), stores shipped; remaining certification rows stay deferred until fixture-linked |
